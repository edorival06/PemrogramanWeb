...
<body>
    ...
    <<form name="update_user" method="post" action="edit_process.php">
        ...
        <tr>
            <td>Email</td>
            <td><input type="text" name="email" vallue=<?php echo $email;?>></td>
        </tr>
        <tr>
            <td>Phone</td>
            <td><input type="text" name="phone" vallue=<?php echo $phone;?>></td>
        </tr>
        <tr>
            <!-- input hidden untuk mengirimkan id -->
            <td><input type="hidden" name="id" vallue=<?php echo $_GET['id'];?>></td>
